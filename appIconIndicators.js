...
var AppIconIndicator = new Lang.Class({
    ...
    _init: function(source, settings) {
        ...
        switch (runningIndicatorStyle) {
            ...
            case RunningIndicatorStyle.GTK:
                runningIndicator = new RunningIndicatorGTK(source, settings);
                break;
...
const RunningIndicatorGTK = new Lang.Class({
    Name: 'DashToDock.RunningIndicatorGTK',
    Extends: RunningIndicatorBase,
    ...
    _updateCounterClass: function() {
     ...
     _computeStyle: function() {
        ...
        this._borderColor = Clutter.color_from_string('rgba(0, 0, 0, 0)')[1];
        this._borderWidth = 0;
